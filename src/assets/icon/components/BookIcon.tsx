export function BookIcon(props: { class?: string }) {
    return (
        <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" className={props.class} xmlns="http://www.w3.org/2000/svg">
